...
namespace CryptoGateway.DataAccess.Migrations
{
    ...
    [Migration("20240519075554_Edit.PayIn.CustomerContact")]
    partial class EditPayInCustomerContact
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("CryptoGateway.Domain.Entities.PayIn.PayIn", b =>
                {
                    ...
                    b.OwnsOne("CryptoGateway.Domain.Entities.PayIn.ValueObjects.CustomerContact", "CustomerContact", b1 =>
                        {
                            b1.Property<int>("PayInId")
                                .HasColumnType("int");
