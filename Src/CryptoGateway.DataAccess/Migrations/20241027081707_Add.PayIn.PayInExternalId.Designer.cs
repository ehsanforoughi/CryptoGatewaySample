...
namespace CryptoGateway.DataAccess.Migrations
{
    ...
    [Migration("20241027081707_Add.PayIn.PayInExternalId")]
    partial class AddPayInPayInExternalId
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("CryptoGateway.Domain.Entities.ContractAccount.ContractAccount", b =>
                {
                    b.HasOne("CryptoGateway.Domain.Entities.CustodyAccount.CustodyAccount", "CustodyAccount")
                        .WithOne("ContractAccount")
                        .HasForeignKey("CryptoGateway.Domain.Entities.ContractAccount.ContractAccount", "CustodyAccountId")
                        .OnDelete(DeleteBehavior.NoAction)
                        .IsRequired();
            ...
            modelBuilder.Entity("CryptoGateway.Domain.Entities.PayIn.PayIn", b =>
                {
                    ...
                    b.OwnsOne("CryptoGateway.Domain.Entities.PayIn.ValueObjects.PayInExternalId", "PayInExternalId", b1 =>
                        {
                            b1.Property<int>("PayInId")
                                .HasColumnType("int");
