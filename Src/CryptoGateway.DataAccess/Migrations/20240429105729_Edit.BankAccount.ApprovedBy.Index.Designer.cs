...
namespace CryptoGateway.DataAccess.Migrations
{
    ...
    [Migration("20240429105729_Edit.BankAccount.ApprovedBy.Index")]
    partial class EditBankAccountApprovedByIndex
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("CryptoGateway.Domain.Entities.Auth.Menu", b =>
                {
            ...
            modelBuilder.Entity("CryptoGateway.Domain.Entities.Auth.MenuInRole", b =>
                {
            ...
            modelBuilder.Entity("CryptoGateway.Domain.Entities.Auth.Role", b =>
                {
                    b.Property<int>("RoleId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("CryptoGateway.Domain.Entities.Auth.UserInRole", b =>
                {
            ...
            modelBuilder.Entity("CryptoGateway.Domain.Entities.Auth.Menu", b =>
                {
                    b.HasOne("CryptoGateway.Domain.Entities.Auth.Menu", "Parent")
                        .WithMany("ChildMenus")
            ...
            modelBuilder.Entity("CryptoGateway.Domain.Entities.Auth.MenuInRole", b =>
                {
                    b.HasOne("CryptoGateway.Domain.Entities.Auth.Menu", "Menu")
                        .WithMany("MenuInRoles")
                        .HasForeignKey("MenuId")
                        .OnDelete(DeleteBehavior.NoAction)
                        .IsRequired();

                    b.HasOne("CryptoGateway.Domain.Entities.Auth.Role", "Role")
                        .WithMany("MenuInRoles")
            ...
            modelBuilder.Entity("CryptoGateway.Domain.Entities.PayIn.PayIn", b =>
                {
                    ...
                    b.OwnsOne("CryptoGateway.Domain.Entities.PayIn.ValueObjects.CustomerEmail", "CustomerEmail", b1 =>
                        {
                            b1.Property<int>("PayInId")
                                .HasColumnType("int");
            ...
            modelBuilder.Entity("CryptoGateway.Domain.Entities.Payment.Payment", b =>
                {
                    ...
                    b.OwnsOne("CryptoGateway.Domain.Entities.Payment.ValueObjects.OrderId", "OrderId", b1 =>
                        {
                            b1.Property<int>("PaymentId")
                                .HasColumnType("int");
            ...
            modelBuilder.Entity("CryptoGateway.Domain.Entities.Payout.Payout", b =>
                {
                    ...
                    b.OwnsOne("CryptoGateway.Domain.Entities.Shared.ValueObjects.UserId", "ApprovedBy", b1 =>
                        {
            ...
            modelBuilder.Entity("CryptoGateway.Domain.Entities.User.User", b =>
                {
                    b.OwnsOne("CryptoGateway.Domain.Entities.Shared.ValueObjects.UserId", "Id", b1 =>
                        {
                    ...
                    b.OwnsOne("CryptoGateway.Domain.Entities.User.ValueObjects.Email", "Email", b1 =>
                        {
                            b1.Property<int>("UserId")
                                .HasColumnType("int");
                    ...
                    b.OwnsOne("CryptoGateway.Domain.Entities.User.ValueObjects.Password", "Password", b1 =>
                        {
                            b1.Property<int>("UserId")
                                .HasColumnType("int");
