...
@Component({
  selector: 'app-crypto-payin',
  standalone: true,
  imports: [
    SharedModule
  ],
  templateUrl: './crypto-payin.component.html',
  styleUrl: './crypto-payin.component.scss'
})
export class CryptoPayinComponent implements OnInit {
